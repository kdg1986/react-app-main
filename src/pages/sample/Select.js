...
export default () => {
  ...
  return (
    <>
      ...
      <Typo>{"import YBSelect from '@/components/YBSelect';"}</Typo>
      <br />
      <Typo codeStyle={false} copyable={false}>
        {'const optionList = [ { label : "A1", value : "A1" }, { label : "A2", value : "A2" }, ]'}
      </Typo>
...
`}</pre>
      ...
      <Addrow
        ...
        code={
          <>
            <Typo>
              {'<YBSelect onClear={(a,b)=>alert(a,b)} options={optionList} allowClear={true}/>'}
            </Typo>
          </>
        }
      />
