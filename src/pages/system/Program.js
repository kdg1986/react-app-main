...
const SearchOptions = props => {
  ...
  return (
    <>
      ...
      <Divider />
      <Row justify="end">
        <Button type="primary" icon={<SearchOutlined />} onClick={() => props.doSearch(state)}>
          Search
        </Button>
      </Row>
    </>
    ...
    <Table
      ...
      columns={[
        ...
        },
        {
          title: '프로그램 NO',
          dataIndex: 'programNo',
          sorter: (a, b) => a.programNo > b.programNo,
        },
        ...
        { title: '프로그램 파일명', dataIndex: 'programFileName' },
        {
          ...
          render: (text, record, index) => (
            <Checkbox key={uuidv4()} checked={text === 'Y' ? true : false}></Checkbox>
          ),
        },
        {
          title: '수정일자',
          dataIndex: 'modiDate',
          sorter: (a, b) => (a.modiDate < b.modiDate ? -1 : a.modiDate > b.modiDate ? 1 : 0),
        },
      ]}
...
export default () => {
  ...
  return (
    <>
      <Card>
        <SearchOptions disabled1={true} disabled2={true} doSearch={doSearch} />
      </Card>
      <div style={style}>
        <Row>
          <Col span={12}>
          ...
          <Col span={12}>
            <Row justify="end">
              <div style={{ padding: '0 3px' }}>
                {' '}
                <Button icon={<SearchOutlined />}>신규</Button>{' '}
              </div>
              <div style={{ padding: '0 3px' }}>
                {' '}
                <Button icon={<SearchOutlined />}>삭제</Button>{' '}
              </div>
              <div style={{ padding: '0 3px' }}>
                {' '}
                <Button icon={<SearchOutlined />}>취소</Button>{' '}
              </div>
              <div style={{ padding: '0 3px' }}>
                {' '}
                <Button icon={<SearchOutlined />}>엑셀</Button>{' '}
              </div>
            </Row>
          </Col>
        </Row>
      ...
      <div style={style}>
        <Row>
          <Col span={12}>
            <Row>
              <Title level={4}>
                <EnvironmentOutlined /> 프로그램 상세 정보
              </Title>
            </Row>
          </Col>
          <Col span={12}>
            <Row justify="end">
              <div style={{ padding: '0 3px' }}>
                {' '}
                <Button icon={<SearchOutlined />} onClick={doSave}>
                  저장
                </Button>{' '}
              </div>
            </Row>
